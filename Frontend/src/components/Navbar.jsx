...
function Navbar() {
  ...
  <div className="navbar-start">
    ...
    <a className="text-xl font-bold cursor-pointer">Magazine Store</a>
  </div>
...
<label className="px-2 py-2 border rounded-md flex items-center gap-2">
  <input type="text" className="grow ouline-none dark:bg-slate-900 dark:text-white" placeholder="Search" />
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 16 16"
    fill="currentColor"
